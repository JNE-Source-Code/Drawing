...
public class MainActivity extends AppCompatActivity implements RtmpHandler.RtmpListener,
    ...
    private String Url = "rtmp://project-drawing-6cd8e.firebaseapp.com/camerastreams/rdkUX0bzZacw7PHcQp2n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rtmpUrl = sp.getString("rtmpUrl", Url);
        ...
        mPublisher.switchCameraFace((mPublisher.getCameraId() + 2) % Camera.getNumberOfCameras());
        ...
        btnRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                if (btnRecord.getText().toString().contentEquals("pause")) {
